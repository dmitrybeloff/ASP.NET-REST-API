...
{
    public class DeleteBookReviewCommandHandler : IRequestHandler<DeleteBookReviewCommand, bool>
    {
        private readonly IBookRepository bookRepository;

        public DeleteBookReviewCommandHandler(IBookRepository bookRepository)
        {
            this.bookRepository = bookRepository;
        }

        public async Task<bool> Handle(DeleteBookReviewCommand request, CancellationToken cancellationToken)
        {
            ...
            if (book.DeleteReview(request.BookReviewId))
            {
